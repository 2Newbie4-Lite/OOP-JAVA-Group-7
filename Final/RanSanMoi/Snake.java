...
public class Snake {
    ...
    public void setDirection(Direction RIGHT) {
        ...
        boolean opposite =
                (RIGHT == Direction.UP && direction == Direction.DOWN) ||
                        (RIGHT == Direction.DOWN && direction == Direction.UP) ||
                        (RIGHT == Direction.LEFT && direction == Direction.RIGHT) ||
                        (RIGHT == Direction.RIGHT && direction == Direction.LEFT);
